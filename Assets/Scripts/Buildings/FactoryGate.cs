...
{
    /// <summary>
    /// Анімує поворот брами заводу між кутами X відкритого та закритого положення.
    /// Корутини Open/Close очікуються BuildingProduction під час спавну юнітів.
    /// </summary>
    public class FactoryGate : MonoBehaviour
    {
        ...
        /// <summary>Корутина, що повертає піввісь брами до кута X відкритого положення.</summary>
        public IEnumerator Open()
        {
            yield return RotateGate(_openXAngle);
        }

        /// <summary>Корутина, що повертає піввісь брами назад до кута X закритого положення.</summary>
        public IEnumerator Close()
        {
            yield return RotateGate(_closedXAngle);
        }

        /// <summary>Поступово обертає піввісь брами до targetXAngle зі швидкістю _rotationSpeed градусів/секунду, зберігаючи Y та Z.</summary>
